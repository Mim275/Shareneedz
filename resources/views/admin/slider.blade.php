            ...
            <div class="card-body">
                ...
                <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input name="name_bn" type="name" value="" class="form-control" id="inputName2">
                                        </div>
                ...
                <table id="table_id1" class="display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->title}}</td>
                                        <td>
                                            <img style="width:200px;height:100px;"  src="{{asset('uploads/slider/'.$row->slider)}}" alt="slider">
                                        </td>
                                     
                                        <td>
                                                        <a href="{{url('slider/'.$row->id.'/edit')}}" class="btn btn-icon btn-primary"><i class="fas fa-pen-nib"></i></a>
                                                       

                                                        <form id="delete-form-{{ $row->id }}" action="{{route('slider.destroy',$row->id)}}" style="display: none;" method="POST">
                                                        @method('DELETE')    
                                                        @csrf
