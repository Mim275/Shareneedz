...
@section('content')
 ...
 <header class="bg-white shadow-sm px-4 py-3 z-index-20">
    <div class="container-fluid px-0">
            <h2 class="mb-0 p-1">Donnner Setting</h2>
    </div>
</header>
    ...
    <div class="container-fluid">
        <div class="card mb-0">
            <div class="card-body">
                ...
                <form action="{{url('donner/'.$data->id)}}" method="POST" enctype="multipart/form-data">
                @method('put')                         
                @csrf
                                        ...
                                        <div class="col-12">
                                        <label class="form-label">donner Member Image : size : 500 x 300 & under 2MB </label>
                                        ...
                                        <div class="userProfile-formBtn mt-3">
                                                <a href="{{route('donner.index')}}" class="btn btn-outline-dark me-3" type="reset">BACK</a>
