...
@section('content')
 ...
 <header class="bg-white shadow-sm px-4 py-3 z-index-20">
    <div class="container-fluid px-0">
            <h2 class="mb-0 p-1">Donner Setting</h2>
    </div>
</header>
    ...
    <div class="container-fluid">
        <div class="card mb-0">
            <div class="card-body">
                ...
                <form action="{{route('donner.store')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                ...
                <table id="table_id1" class="display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->name}}</td>
                                        <td>
                                            <img style="width:200px;height:100px;"  src="{{asset('uploads/donner/'.$row->image)}}" alt="slider">
                                        </td>
                                        <td>{{$row->facebook}}</td>
                                      
                                     
                                        <td>
                                                        <a href="{{url('donner/'.$row->id.'/edit')}}" class="btn btn-icon btn-primary"><i class="fas fa-pen-nib"></i></a>
                                                       

                                                        <form id="delete-form-{{ $row->id }}" action="{{route('donner.destroy',$row->id)}}" style="display: none;" method="POST">
                                                        @method('DELETE')    
                                                        @csrf
