...
<div class="col-12">   
        ...
        <div class="receipt-main ">
            ...
            <div class="row mb-3 header-top">
                ...
                <div class="col-6">
                        <div class=" mt-3">
							<h3>INVOICE # {{ 100 + $invoice_number->id }}
                            </h3>
                            <p>Date: {!! date('d-m-Y', strtotime($invoice_number->paydate)) !!} </p>
						</div>
                </div>
			...
			<hr class="table-space" >
				<table class="table table-bordered" >
						...
						<tbody>
							<tr>
								<td class="col-3">{{$invoice_number['paytype']}} </td>
								<td class="col-3">{{$invoice_number['anumber']}}</td>
								<td class="col-3">{{$invoice_number['tid']}}</td>
								<td class="col-3">{{$invoice_number['amount']}}/-</td>
							</tr>
							...
							<tr>
								...
								<td class="text-left text-danger"><h2><strong><i class="fa fa-inr"></i> {{$invoice_number['amount']}}/-</strong></h2></td>
